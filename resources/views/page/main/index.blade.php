...
@section('content')
    ...
    <div class="container">
      <div class="col ps-5">
        ...
        @else
          <h5>Halo {{ session("guest_id") }}, ayo mulai belajar!</h5
        @endif
      </div>
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 justify-content-center gap-3 mt-4">
        <div class="card d-grid" style="width: 18rem;">
            ...
            <div class="card-body align-self-end">
              ...
              <p class="card-text">Tingkatkan kemampuan berbicara Anda dalam bahasa Arab melalui latihan interaktif dan panduan khusus yang dirancang untuk semua level.</p>
              <div class="d-grid">
          ...
          <div class="card d-grid" style="width: 18rem;">
            ...
            <div class="card-body align-self-end">
              ...
              <p class="card-text"> Asah keterampilan membaca Anda dengan materi bahasa Arab yang menarik dan latihan evaluasi mandiri.</p>
              <div class="d-grid">
          ...
          <div class="card d-grid" style="width: 18rem;">
            ...
            <div class="card-body align-self-end">
              ...
              <p class="card-text">Uji kemampuan Anda melalui berbagai soal pilihan ganda dan tantangan menarik untuk memperkuat pemahaman.</p>
              <div class="d-grid">
                <a href="#" class="btn btn-primary">Buka Sekarang</a>
              </div>
            </div>
