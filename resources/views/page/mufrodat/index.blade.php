...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="max-w-3xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                <div class="bg-white/10 backdrop-blur rounded-lg p-4">
                    <div class="text-3xl font-bold">{{ count($mufrodat) }}</div>
                    <div class="text-blue-100">Total Bab</div>
                </div>
                <div class="bg-white/10 backdrop-blur rounded-lg p-4">
                    <div class="text-3xl font-bold">500+</div>
                    <div class="text-blue-100">Kosakata</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div class="md:col-span-2 bg-white p-6 rounded-xl shadow-sm">
            <h2 class="text-xl font-bold text-gray-800 mb-4">Panduan Belajar Mufrodat</h2>
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">Mulai dari bab pertama untuk memahami kosakata dasar</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm">
            ...
            <ul class="space-y-3">
                ...
                <li class="flex items-center gap-2">
                    <span class="w-2 h-2 bg-blue-500 rounded-full"></span>
                    <span class="text-gray-600 text-sm">Catat kosakata baru</span>
                </li>
                <li class="flex items-center gap-2">
                    <span class="w-2 h-2 bg-blue-500 rounded-full"></span>
                    <span class="text-gray-600 text-sm">Praktikkan dalam kalimat</span>
                </li>
                <li class="flex items-center gap-2">
                    <span class="w-2 h-2 bg-blue-500 rounded-full"></span>
    ...
    <!-- Mufrodat List Section -->
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Daftar Bab Mufrodat</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    <div class="space-y-2">
                        <h3 class="text-xl font-bold text-gray-800">{{ ucfirst($m['nama_materi']) }}</h3>
                    ...
                    <a 
                        href="{{ Route('konten_mufrodat_index', $m['urutan_bab']) }}" 
